...
const SocketServer = (server) => {
  ...
  io.on('connection', (socket) => {
    ...
    socket.on('typing', (message) => {
      console.log('Hello typing: ', message);
    ...
    socket.on('add-friend', (chats) => {
      console.log('Hello add-friend: ', chats);
      try {
        let online = 'offline';
    ...
    socket.on('add-user-to-group', ({ chat, newChatter }) => {
      console.log('Hello add-user-to-group: ', chat, newChatter);
    ...
    socket.on('leave-current-chat', (data) => {
      console.log('Hello leave-current-chat: ', data);
    ...
    socket.on('delete-chat', (data) => {
      console.log('Hello delete-chat: ', data);
    ...
    socket.on('disconnect', async () => {
      console.log('Hello disconnect: ', socket.id);
